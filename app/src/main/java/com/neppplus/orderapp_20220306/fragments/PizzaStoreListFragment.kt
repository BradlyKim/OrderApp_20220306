...
import com.neppplus.orderapp_20220306.ViewStoreDetailActivity
import com.neppplus.orderapp_20220306.adapters.StoreAdapter
...
class PizzaStoreListFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mPizzaStoreList.add(StoreData("파파존스", 5.0, "1577-8080", "http://mblogthumb2.phinf.naver.net/20160530_65/ppanppane_1464617766007O9b5u_PNG/%C6%C4%C6%C4%C1%B8%BD%BA_%C7%C7%C0%DA_%B7%CE%B0%ED_%284%29.png?type=w800"))
        mPizzaStoreList.add(StoreData("도미노피자", 4.0, "1577-3082", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZwWyvyveJIOBHSb_0LGWqf2W3RScou8Xqm9juEP6RjlxKJSfJv5ED1VJGnqzOjf4Xyog&usqp=CAU"))
